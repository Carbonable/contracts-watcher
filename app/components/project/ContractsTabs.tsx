        ...
        <Tabs.Root defaultValue="addresses" className='flex flex-col mt-8 w-full'>
            <Tabs.List className="shrink-0">
                <div className='w-full flex overflow-x-scroll'>
                    ...
                    <Tabs.Trigger value="migrator" className={triggerClassName} >Migrator</Tabs.Trigger>
                </div>
                <div className='w-full'>
                    ...
                    <Tabs.Content value="migrator" className={contentClassName}><Migrator /></Tabs.Content>
                </div>
            </Tabs.List>
        </Tabs.Root>
    );
